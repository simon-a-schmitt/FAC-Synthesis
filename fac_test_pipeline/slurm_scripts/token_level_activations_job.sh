...
export PROMPTS_JSON="$WS_PATH/code/FAC-Synthesis/fac_test_pipeline/input/prompts_seed_casehold.json"
...
OUTPUT_JSONL="${OUTPUT_BASE}/results_prompts_seed_casehold_token_shard${TASK_ID}.jsonl"
...
python "$WS_PATH/code/FAC-Synthesis/fac_test_pipeline/run_fac_test_pipeline_token_matrix.py" \
