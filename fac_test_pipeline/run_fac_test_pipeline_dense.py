...
def extract_latent_for_prompt(prompt: str, model: UnifiedGenerator, collector: Collector, sae: TopKSAE) -> tc.Tensor:
    ...
    token_latents = sae.encode_dense(hidden_seq)
    ...
    # Determine content start after chat header and skip leading newlines
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="FAC dense test pipeline: prompt -> Llama activations -> SAE dense latent vectors.")
